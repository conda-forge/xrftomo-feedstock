About xrftomo-feedstock
=======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/xrftomo-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/tomography/XRFtomo
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9333&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/xrftomo-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `xrftomo` can be installed with `conda`:
...
```
mamba install xrftomo
```

It is possible to list all of the versions of `xrftomo` available on your platform with `conda`:
...
```
mamba search xrftomo --channel conda-forge
```
...
mamba repoquery search xrftomo --channel conda-forge

# List packages depending on `xrftomo`:
mamba repoquery whoneeds xrftomo --channel conda-forge

# List dependencies of `xrftomo`:
mamba repoquery depends xrftomo --channel conda-forge
```
